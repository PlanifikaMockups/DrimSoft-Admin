      ...
      <div className={cn(
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="px-6 py-4 border-b border-gray-200 dark:border-slate-700/50">
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center">
                <DrimSoftLogo className="h-6 w-6 text-[#3A6EA5]" />
            ...
            <div 
              className={cn(
                "relative p-4 rounded-2xl border-2 cursor-pointer transition-all duration-300 hover:shadow-lg",
            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    <div className={cn("text-lg font-bold font-['Poppins']", activePlatform.textColor)}>
                      {activePlatform.name}
                    </div>
                    <div className={cn("text-sm font-['Inter']", activePlatform.textColor)}>
          ...
          <div className="p-6 border-b border-gray-200 dark:border-slate-700/50">
            <div className="flex items-center space-x-4">
              <div className="relative">
                ...
                />
                <div className="absolute -bottom-1 -right-1 h-4 w-4 bg-[#4CAF50] border-2 border-white dark:border-slate-800 rounded-full"></div>
              </div>
              <div className="flex-1 min-w-0">
                <p className="text-lg font-semibold text-gray-900 dark:text-white truncate font-['Poppins']">{user.name}</p>
                <p className="text-sm text-gray-600 dark:text-gray-300 capitalize font-['Inter']">
                  {user.role.replace('_', ' ')}
                </p>
                {user.institution && (
            ...
            <div className="mt-4 grid grid-cols-2 gap-3">
              <div className="text-center p-3 bg-gray-100 dark:bg-white/5 rounded-xl">
                <div className="text-lg font-bold text-gray-900 dark:text-white font-['Poppins']">{activePlatform.stats.organizations}</div>
                <div className="text-xs text-gray-600 dark:text-gray-400 font-['Inter']">Organizaciones</div>
              </div>
              <div className="text-center p-3 bg-gray-100 dark:bg-white/5 rounded-xl">
                <div className="text-lg font-bold text-gray-900 dark:text-white font-['Poppins']">{activePlatform.stats.users}K+</div>
          ...
          <nav className="flex-1 px-6 py-8 space-y-3">
            <div className="text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wider mb-4 font-['Inter']">
          ...
          {user.institution && (
            <div className="p-6 border-t border-gray-200 dark:border-slate-700/50">
              ...
              <div className="flex items-center space-x-3 p-3 bg-gray-100 dark:bg-white/5 rounded-xl">
                <Building className="h-5 w-5 text-[#3A6EA5]" />
                <div>
                  <div className="text-sm font-medium text-gray-800 dark:text-gray-200 font-['Inter']">{user.institution}</div>
          ...
          {/* Footer Mejorado */}
          <div className="p-6 border-t border-gray-200 dark:border-slate-700/50">
            <div className="flex items-center justify-center p-3 bg-gray-100 dark:bg-white/5 rounded-xl">
