...
export function Header() {
  ...
  return (
    <header className="bg-white dark:bg-slate-900 border-b border-gray-200 dark:border-slate-700 px-3 sm:px-4 lg:px-6 py-3 sm:py-4 sticky top-0 z-40">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-2 sm:space-x-4">
          ...
          <div className="relative hidden md:block">
            ...
            <Input
              ...
              className="pl-10 w-60 lg:w-80 bg-white dark:bg-slate-800 border-gray-200 dark:border-slate-600"
              onKeyDown={(e) => {
                if (e.key === '/') {
                  e.preventDefault()
          ...
          <div className="flex items-center space-x-2 ml-2 sm:ml-4">
            ...
            />
            <span className="text-xs sm:text-sm text-muted-foreground hidden xl:block">Powered by Planifika</span>
          </div>
        </div>
        ...
        <div className="flex items-center space-x-1 sm:space-x-2">
          ...
          {/* User Dropdown */}
          <div ref={dropdownRef} className="relative pl-1 sm:pl-2 border-l border-gray-200 dark:border-slate-700">
            <Button
              variant="ghost"
              className="flex items-center space-x-2 sm:space-x-3 px-2 sm:px-3 py-2 hover:bg-gray-100 dark:hover:bg-slate-800"
            ...
            {/* Dropdown Menu */}
            {userDropdownOpen && (
              <div className="absolute right-0 mt-2 w-56 sm:w-64 bg-white dark:bg-slate-800 rounded-lg shadow-lg border border-gray-200 dark:border-slate-700 py-2 z-50">
